    ...
    return (
        <section id="welcome">
            ...
            <h3 className="text-large special-shadow">
                {/*Welcome to <span className="text-gradient">noema</span>*/}
                365 days.<br />uncountable words.
            </h3>
            ...
            <div>
                <input value={name} onChange={handleChange} type="text" placeholder="enter your name..." />
